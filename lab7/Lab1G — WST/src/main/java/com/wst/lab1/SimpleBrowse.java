...
public class SimpleBrowse
{
    ...
    /** Выводит базовую информацию в консоль, поиск */
    public SimpleBrowse()
    {
        try
        {
     ...
     * @param name имя бизнеса */
    public void browse(String username, String password, String name)
    {
        try
        {
            String token = getAuthKey(username, password);
    ...
    private BusinessList getBusinessList(String token, String name) throws Exception
    {
        ...
        searchname.setValue(/*UDDIConstants.WILDCARD*/name);
        fb.getName().add(searchname);
        BusinessList findBusiness = inquiry.findBusiness(fb);
        return findBusiness;
    }

    /** Конвертирует CategoryBag в строку */
    private String categoryBagToString(CategoryBag categoryBag)
    {
    ...
    /** Конвертирует KeyedReference в строку */
    ...
    private void printServiceDetail(BusinessService get)
    {
        ...
        System.out.println("Cat bag " + categoryBagToString(get.getCategoryBag()));
    ...
    /** Переводит данные из uddi-формата в строковое представление */
    ...
    /** Конвертирует лист имён в строковое представление */
    ...
    /** Конвертирует лист описаний в строковое представление */
    ...
    /** Выводит лист сервисной информации */
    ...
    private void printBusinessDetails(BusinessInfos businessInfos, String token) throws Exception
    {
        ...
        for (int i = 0; i < businessDetail.getBusinessEntity().size(); i++)
        {
            ...
            System.out.println("CategoryBag: " + categoryBagToString(businessDetail.getBusinessEntity().get(i).getCategoryBag()));
