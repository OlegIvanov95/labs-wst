 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://lab1.wst.com/", wsdlLocation = "http://localhost:8080/PersonWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://lab1.wst.com/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/PersonWebService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://lab1.wst.com/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1.wst.com/", "PersonWebServicePort"), PersonWebService.class, features);
    }
